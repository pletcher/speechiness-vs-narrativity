"""
This module doesn't actually compare messenger speeches
yet, as these data have not yet been prepared for
Aristophanes.
"""
...
OUT_CSV = ROOT_DIR / "csv" / "ARISTOPHANES_messenger_speech_narrativity.csv"
    ...
    for file in aristophanes:
        ...
        for sent in sentences:
            ...
            for sentence in sents["sentences"]:
                ...
                # ) or any(first_line <= start and last_line >= end for start, end in ranges)
